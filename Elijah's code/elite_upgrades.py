...
pickaxe_efficiency_description = "Your pickaxes will now be more efficient! Increases the multiplier for all buildings by 1.5 for each level of this upgrade. The cost of this upgrade increases by 150% with each purchase."
...
asteroid_mining_description = "You will now be able to mine asteroids! Increases the multiplier for all buildings by 50 for each level of this upgrade. The cost of this upgrade increases by 650% with each purchase."

diamond_pickaxe_description = "Your pickaxe will now be made of diamond! Increases the multiplier for all buildings by 100 for each level of this upgrade. The cost of this upgrade increases by 750% with each purchase."
...
upgrade_stats = {
    ...
    "all_building": ("All Building Upgrade", 1.4 * 10**30, 8, 5000, all_building_description)
}
